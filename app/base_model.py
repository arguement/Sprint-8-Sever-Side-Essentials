"""
Credits to: https://wakatime.com/blog/32-flask-part-1-sqlalchemy-models-to-json
Their model allows us to do things: get the desired attributes from a model object in
the form of a dictionary, and to update a model using a dictionary
"""
